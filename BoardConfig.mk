...
ifeq ($(filter trygon trygon_l10n calgon full_stingray tyranid stingray baked_stingray,$(TARGET_PRODUCT)),)
$(warning The stingray device can only be used)
$(warning with the following TARGET_PRODUCT:)
$(warning trygon trygon_l10n calgon full_stingray tyranid stingray baked_stingray)
